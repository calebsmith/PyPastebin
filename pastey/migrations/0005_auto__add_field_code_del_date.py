...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('pastey_code', 'del_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 6, 30, 13, 11, 56, 833627)), keep_default=False)
